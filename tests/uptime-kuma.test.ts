...
const METRICS = `
monitor_response_time_seconds{monitor_id="1",monitor_name="PVE Dell",monitor_type="ping",window="1d"} 0.0009
...
monitor_cert_days_remaining{monitor_id="7",monitor_name="NugaCore Staging",monitor_type="http"} 74
