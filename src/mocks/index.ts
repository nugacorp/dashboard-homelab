...
export const mockProxmoxCluster: ProxmoxCluster = {
  ...
  nodesTotal: 3,
  quorate: true,
  quorumStatus: 'Quorate (3/3 votes)',
  pveVersion: 'PVE 8.3-3',
  cpuUsageAvgPct: 28,
  ramUsedGb: 43.0,
  ramTotalGb: 96.0,
  storageUsedTb: 6.4,
...
export const mockUniFi: UniFiNetwork = {
  ...
  vlans: [
    { id: 1, name: 'Default / LAN', subnet: '192.168.1.0/24', dhcpRange: '192.168.1.100 - 192.168.1.250', isolated: false, clientsCount: 18 },
    { id: 10, name: 'Servers & Management', subnet: '192.168.10.0/24', dhcpRange: 'Static Only', isolated: false, clientsCount: 8 },
    { id: 20, name: 'CCTV & Security', subnet: '192.168.20.0/24', dhcpRange: '192.168.20.10 - 192.168.20.90', isolated: true, clientsCount: 8 },
    { id: 30, name: 'IoT & Smart Home', subnet: '192.168.30.0/24', dhcpRange: '192.168.30.100 - 192.168.30.250', isolated: true, clientsCount: 22 },
    { id: 40, name: 'Guest Wi-Fi', subnet: '192.168.40.0/24', dhcpRange: '192.168.40.50 - 192.168.40.200', isolated: true, clientsCount: 0 }
  ],
  clients: [
    { id: 'cli-01', name: 'Ramiro MacBook Pro M3 Max', hostname: 'ramiro-mbp', ip: '192.168.1.142', mac: 'b4:22:df:8a:c1:90', vlan: 'Default (VLAN 1)', deviceType: 'laptop', apName: 'AP Office & Lab', signalDbm: -48, txRateMbps: 1200, rxRateMbps: 1200, experiencePct: 99, downloadMb: 4850, uploadMb: 820 },
    { id: 'cli-02', name: 'Apple TV 4K - Living Room', hostname: 'appletv-living', ip: '192.168.1.150', mac: '40:6c:8f:2b:11:4a', vlan: 'Media (VLAN 30)', deviceType: 'tv', apName: 'AP Living Room', signalDbm: -42, txRateMbps: 866, rxRateMbps: 866, experiencePct: 98, downloadMb: 12400, uploadMb: 240 },
    { id: 'cli-03', name: 'Mac Studio - AI Worker', hostname: 'mac-studio-ai', ip: '192.168.1.140', mac: 'f8:ff:c2:91:0a:77', vlan: 'Servers (VLAN 10)', deviceType: 'desktop', switchPort: 'Port 8 (10G SFP+)', experiencePct: 100, downloadMb: 8900, uploadMb: 3400 },
    { id: 'cli-04', name: 'Sofia iPhone 15 Pro', hostname: 'sofia-iphone', ip: '192.168.1.144', mac: '7a:11:99:ee:cc:02', vlan: 'Default (VLAN 1)', deviceType: 'phone', apName: 'AP Living Room', signalDbm: -54, txRateMbps: 650, rxRateMbps: 650, experiencePct: 97, downloadMb: 2400, uploadMb: 520 },
    { id: 'cli-05', name: 'UniFi G5 Turret - Front Door', hostname: 'unifi-g5-front', ip: '192.168.20.10', mac: '24:5a:4c:78:01:2b', vlan: 'Cameras (VLAN 20)', deviceType: 'camera', switchPort: 'Port 1 (PoE+)', experiencePct: 100, downloadMb: 110, uploadMb: 16800 },
    { id: 'cli-06', name: 'Home Assistant Yellow', hostname: 'homeassistant', ip: '192.168.1.20', mac: 'dc:a6:32:11:44:88', vlan: 'Servers (VLAN 10)', deviceType: 'server', switchPort: 'Port 4 (GbE)', experiencePct: 100, downloadMb: 320, uploadMb: 410 },
    { id: 'cli-07', name: 'Sonos Arc Soundbar', hostname: 'sonos-arc', ip: '192.168.30.12', mac: '94:9f:3e:44:91:20', vlan: 'IoT (VLAN 30)', deviceType: 'audio', apName: 'AP Living Room', signalDbm: -45, experiencePct: 99, downloadMb: 1800, uploadMb: 35 },
    { id: 'cli-08', name: 'Philips Hue Bridge', hostname: 'hue-bridge', ip: '192.168.30.15', mac: 'ec:b5:fa:22:90:33', vlan: 'IoT (VLAN 30)', deviceType: 'iot', switchPort: 'Port 12 (GbE)', experiencePct: 100, downloadMb: 45, uploadMb: 12 }
  ],
  devices: [
    {
      id: 'udm-pro',
...
export const mockEnergy: EnergyData = {
  ...
  costEstimatedPerMonth: 57.36,
  upsBatteryPct: 100,
  upsRuntimeMinutes: 45,
  ambientTempC: 22.4,
